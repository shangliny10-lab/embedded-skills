...
> 🎓 **面向嵌入式专业大学生的开源学习资源库** —— 从裸机到 Linux，从原理到实战，一套搞定。
>
> 适合课程学习、课程设计、毕业设计、求职准备和项目开发参考。**欢迎 Star ⭐ / Fork 🍴，提交 Issue 和 PR 给出你的意见和改进！**

## 这里有什么

| 类别 | 数量 | 内容 |
|------|------|------|
| 📚 AI Agent Skills | 8 个 | STM32、Arduino/ESP32、FreeRTOS、RT-Thread、Zephyr、通信协议、嵌入式 Linux、调试技巧 |
| 🛠️ 实战示例 | 3 个 | STM32 闪烁灯、ESP32 WiFi 传感器、FreeRTOS 多任务 |
| 🔧 实用工具 | 2 个 | 串口监控工具、ELF 固件分析工具 |

每个 Skill 都包含**原理讲解 + 代码模板 + 调试技巧 + 常见问题排查**，可以直接作为 AI 助手的 Skill 使用，也可以当速查手册读。
